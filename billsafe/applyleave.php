...
<html>
<head>
	<title>Apply Leave | Employee Panel | Billsafe Technologies</title>
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form action="process/applyleaveprocess.php?id=<?php echo $id?>" method="POST">
                        ...
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" style="background-color: #225277; " type="submit">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
